...
@Singleton
@Component(modules = [HttpModule::class , DatabaseModule::class, ServiceModule::class,ConfigModule::class])

interface AppComponent {

     fun server(): HttpServer

    fun studentResource(): StudentResource

    fun mongoDatabase(): MongoDatabase // Add this method
